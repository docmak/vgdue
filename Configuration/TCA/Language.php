...
$TCA['tx_tuvgdue_domain_model_language'] = array(
	'ctrl' => $TCA['tx_tuvgdue_domain_model_language']['ctrl'],
	'interface' => array(
	...
	'columns' => array(
		...
		'l10n_parent' => array(
			...
			'config' => array(
				...
				'foreign_table_where' => 'AND tx_tuvgdue_domain_model_language.pid=###CURRENT_PID### AND tx_tuvgdue_domain_model_language.sys_language_uid IN (-1,0)',
			),
		),
		...
		'name' => array(
			'exclude' => 0,
			'label' => 'LLL:EXT:tu_vgdue/Resources/Private/Language/locallang_db.xlf:tx_tuvgdue_domain_model_language.name',
			'config' => array(
				'type' => 'input',
				'size' => 30,
				'eval' => 'trim,required'
